...
isso vamos criar a função lerPessoas) e depois chamar a função imprimirPessoas que apresenta os
dados na tela. Note que a estrutura “Pessoa” deve ser definida antes das funções que usam a tabela
do tipo “Pessoa” como parâmetro.*/
#include<stdio.h>
#include<stdlib.h>
#define TAM 5
struct Pessoa{
